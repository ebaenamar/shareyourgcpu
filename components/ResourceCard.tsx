      ...
      <div className="grid grid-cols-2 gap-4 mb-4">
        <div className="bg-gray-700/30 p-3 rounded-lg">
          ...
          <div className="flex justify-between items-baseline">
            ...
            <span className="text-sm">{resource.cpuPrice.toFixed(2)} USDC/hr</span>
          </div>
        </div>
        <div className="bg-gray-700/30 p-3 rounded-lg">
          ...
          <div className="flex justify-between items-baseline">
            ...
            <span className="text-sm">{resource.gpuPrice.toFixed(2)} USDC/hr</span>
          </div>
        </div>
      </div>
        ...
        <div className="mt-4 p-3 bg-gray-700/20 rounded-lg border border-gray-700 text-sm">
          ...
          <div className="grid grid-cols-2 gap-x-4 gap-y-2">
            ...
            <div>
              ...
              <span className="ml-2">{resource.cpuPrice.toFixed(2)} USDC/hr</span>
            </div>
            <div>
              <span className="text-gray-400">GPU Price:</span>
              <span className="ml-2">{resource.gpuPrice.toFixed(2)} USDC/hr</span>
            </div>
            <div className="col-span-2">
              <span className="text-gray-400">Estimated Cost (1 hour):</span>
              <span className="ml-2">
                {(resource.cpuCores * resource.cpuPrice + resource.gpuMemory * resource.gpuPrice).toFixed(2)} USDC
              </span>
            </div>
          </div>
        </div>
